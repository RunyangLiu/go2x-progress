...
| [2D 实物建图与地图定位链路](https://github.com/RunyangLiu/go2x-progress/issues/10) | 仿真与建图 | 进行中 | 先验证 go2_return_to_pose.py 的小范围闭环回点；Nav2 需要先确认安装并单独验证 /cmd_vel 到 Go2 的桥接，再决定是否继续 2D 闭环或转向 3D LIO 主线。 |
